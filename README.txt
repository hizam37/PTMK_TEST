...
Отчет
режим 5 вернул результаты за 5556мс 
режим 6 вернул результаты за 999мс
режим 6 вернул результаты быстрее, потому что мы использовали "индекс", который ускоряет получение результатов для запроса select.